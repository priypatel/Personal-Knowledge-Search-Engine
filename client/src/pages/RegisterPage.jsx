  ...
  return (
    <div className="min-h-screen bg-surface flex items-center justify-center px-4">
      <div className="w-full max-w-[380px]">
        ...
        <h1 className="text-[22px] font-medium text-base text-center mb-1">Create account</h1>
        <p className="text-sm text-muted text-center mb-6">Start searching your documents</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[13px] font-medium text-base" htmlFor="displayName">Name</label>
            <input
              id="displayName"
              type="text"
              value={displayName}
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[13px] font-medium text-base" htmlFor="password">
              Password
              <span className="text-faint font-normal ml-1">(min. 8 characters)</span>
            </label>
            <input
              id="password"
              type="password"
